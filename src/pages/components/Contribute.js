...
export default function Contribute() {
  return (
    ...
    <ul>
      ...
      <center>
        <GitHubButton href="https://github.com/oslabs-beta/Realize" data-color-scheme="no-preference: dark; light: dark; dark: dark;" data-size="large" aria-label="Follow @Realize on GitHub">Follow @Realize</GitHubButton>
        &nbsp;&nbsp;&nbsp;
